  ...
  return createPortal(
    ...
    >
      ...
      <p className="font-light pt-2 w-[90%]">
        Karakteristik yang terdapat dalam Cluster 1 mencakup berbagai aspek yang
      ...
      <div className="py-4 px-6 bg-[#F5F9F9] rounded-lg">
        <div className="flex items-center">
          ...
          <h2 className="bg-[#0B7175] text-xs lg:text-base text-white font-semibold rounded-2xl py-1 px-2 ml-2">
